...
![Local Image](src/assets/images-anlp/1.png)
...
![Local Image](src/assets/images-anlp/2.png)
...
![Local Image](src/assets/images-anlp/4.png)
...
![Local Image](src/assets/images-anlp/3.png)
...
这是一种对训练数据的处理方法  
![Local Image](src/assets/images-anlp/5.png)  
...
### 4.2 transformer
![Local Image](src/assets/images-anlp/6.png)
...
4. **残差连接和层归一化（residual + layer normalization）**  
  ...
  ![Local Image](src/assets/images-anlp/7.png)  
  层归一化：归一化家族中的一员。不得不放上经典的图：  
  ![Local Image](src/assets/images-anlp/8.png)  
  ...
  >补充：layer norm的位置：
  >![Local Image](src/assets/images-anlp/9.png)
  >最早论文中是进行后置，但是前后置有差别
...
![Local Image](src/assets/images-anlp/10.png)  
通过这些修改，模型性能有了显著提升
![Local Image](src/assets/images-anlp/11.png)
...
![Local Image](src/assets/images-anlp/12.png)  
...
![Local Image](src/assets/images-anlp/13.png)  
...
![Local Image](src/assets/images-anlp/14.png)
...
![Local Image](src/assets/images-anlp/15.png)  
...
这张图展示了一种两全其美的策略：
![Local Image](src/assets/images-anlp/16.png) 
