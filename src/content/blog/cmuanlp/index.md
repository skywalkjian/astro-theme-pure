...
类似于搜索策略对探索算法的改进，我们利用这种类似广度搜索的策略来找到整体意义上的最优句子生成策略。  
...
>### 核心思想：不要重复计算已经算过的内容
>
>一句话概括：**KV Cache 是一种用于存储注意力机制（Attention）中间计算结果（Key 和 Value 向量）的技术，以避免在生成每个新词时进行大量重复计算。**
>
>---
>
...
如上图，我们解释了一个在让大语言模型处理长文本时非常关键的工程问题：**如何在上下文越来越长的情况下，保持快速的生成速度**。它介绍了一种名为 **“注意力下沉”（Attention Sinks）** 的技术。
...
### 3. 新的解决方案：注意力汇点 (Attention Sinks)
